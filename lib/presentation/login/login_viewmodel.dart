...
import 'package:appwrite_incidence_employe/app/functions.dart';
...
import 'package:appwrite_incidence_employe/presentation/common/freezed_data_classes.dart';
...
import 'package:appwrite_incidence_employe/presentation/resources/strings_manager.dart';
  ...
  login(BuildContext context) async {
    ...
    (await _loginUsecase.execute(
      ...
      (await _loginUsecase.user(r.userId)).fold(
          ...
          (user) async {
        if (user.active && user.typeUser == AppStrings.employe) {
